...
document.addEventListener('DOMContentLoaded', () => {
    ...
    openModalBtn.addEventListener('click', async (e) => {
        ...
        if (!overlay) {
            try {
                // Fetch the HTML
                const response = await fetch('/Admin/Pages/ProfilePage/Profile.html');
                ...
                if (!document.querySelector('link[href*="Profile.css"]')) {
                    ...
                    link.rel = 'stylesheet';
                    link.href = '/Admin/Pages/ProfilePage/Profile.css';
                ...
                if (!document.querySelector('script[src*="Profile.js"]')) {
                    ...
                    script.src = '/Admin/Pages/ProfilePage/Profile.js';
