...
(function() {
    const initAddCheckpointBtn = () => {
        ...
        addBtn.addEventListener('click', async (e) => {
            ...
            if (!overlay) {
                try {
                    const response = await fetch('/Admin/Pages/CheckpointManagement/AddCheckpoint.html');
                    ...
                    if (!document.querySelector('link[href*="AddCheckpoint.css"]')) {
                        ...
                        link.rel = 'stylesheet';
                        link.href = '/Admin/Pages/CheckpointManagement/AddCheckpoint.css?v=' + new Date().getTime();
