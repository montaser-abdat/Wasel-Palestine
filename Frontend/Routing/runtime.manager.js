(function (global) {
  ...
  const SHARED_MAP_RUNTIME_JS = "/Js/api/map.shared.js";
  const MAP_GEOLOCATION_RUNTIME_JS = "/JS/api/map.geolocation.js";
  const MAP_WIDGETS_RUNTIME_JS = "/JS/api/map.widgets.js";
  const ROUTE_PLANNER_LOGIC_JS =
    "/User/Pages/RoutePlanner/RoutePlannerPage.js";
  const ROUTE_PLANNER_LIFECYCLE_JS =
    "/User/Pages/RoutePlanner/RoutePlannerPage.lifecycle.js";
  ...
  async function initHomeRuntime() {
    ...
    await ensureScript("/Js/api/Weather.js");
