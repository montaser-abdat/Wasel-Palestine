(function (global) {
  const LOGOUT_HTML = "/User/Pages/LogoutPage/Logout.html";
  const LOGOUT_CSS = "/User/Pages/LogoutPage/Logout.css";
  ...
  function bindCloseHandlers(overlay) {
    ...
    overlay.onclick = (event) => {
      ...
      const clickedCloseButton = target.closest(".btn-cancel, .btn-logout");
