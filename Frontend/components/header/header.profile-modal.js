(function (global) {
  const PROFILE_HTML = "/User/Pages/ProfilePage/Profile.html";
  const PROFILE_CSS = "/User/Pages/ProfilePage/Profile.css";
  const PROFILE_JS = "/User/Pages/ProfilePage/Profile.js";
